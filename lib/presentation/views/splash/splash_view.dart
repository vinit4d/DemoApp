...
// import 'package:surveyliteapp/config/extensions/imagePaths.dart';
// import 'package:surveyliteapp/config/extensions/num_extensions.dart';
// import 'package:surveyliteapp/config/logger.dart';
//
// import '../../../data/local_service/cache_service.dart';
// import '../../../domain/shared/app_data.dart';
import '../../theme/app_colors.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(const Duration(seconds: 3), () async {
        ...
        print("works");
          theContext?.navigateReplacedNamed( AppRoute.loginRoute, arguments: false);
        //
        // } else {
        //   theContext?.navigateReplacedNamed( AppRoute.bottomNavBar, arguments: 0);
        //
        // }
      });
    });
    ...
    return Scaffold(
      body: Container(
        ...
        child: Stack(children: [
          ...
          Center(
            child: Padding(
              padding: const EdgeInsets.only(bottom: 100,top: 50, left: 100, right: 100),
